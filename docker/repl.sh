...
mkdir -p m2
mkdir -p lein
docker run -ti --rm -w /home/summit/docker --add-host mysql.dev:10.10.0.110 --add-host mysql.prod:10.5.0.138 -p 127.0.0.1:7003:7003 -p 127.0.0.1:3007:3007 -v $(pwd -P)/..:/home/summit/docker -v $(pwd -P)/m2:/home/summit/.m2 -v $(pwd -P)/lein:/home/summit/.lein -v $(pwd -P)/../../utils:/home/summit/utils timmus lein repl
